...
ABS is coordinated by the [Hu Fu Center for East Asia Democratic Studies](http://www.asianbarometer.org/structure){target="_blank"} at the National Taiwan University. 

Instructions for data access can be found at <http://www.asianbarometer.org/data/data-release>{target="_blank"}.
...
More information on these datasets and instructions for data access can be found at <https://lkyspp.nus.edu.sg/ips/research/surveys/public-data-sharing-platform>{target="_blank"}.
...
Principal Investigators for PHASE are Associate Professor [Angelique Chan](https://www.duke-nus.edu.sg/hssr/our-team/faculty/faculty-staff-details/Detail/13200){target="_blank"}, Professor [David Matchar](https://www.duke-nus.edu.sg/hssr/our-team/faculty/faculty-staff-details/Detail/31920){target="_blank"}, and Assistant Professor [Rahul Malhotra](https://www.duke-nus.edu.sg/hssr/our-team/faculty/faculty-staff-details/Detail/30743){target="_blank"} at Duke-NUS Medical School.

Instructions for data access can be found at <https://www.duke-nus.edu.sg/care/research/dataset-codebook>{target="_blank"}.

## World Values Survey (WVS) {#wvs}

The World Values Survey is a global study to help social scientists understand changes in the beliefs, values and motivations of people across multiple countries. To date, there have been 7 waves of data collection (repeated cross-section, not panel) from almost 100 countries. The survey includes questions on societal trust, religion, work, security, and politics. Singapore participated in Wave 4 (2002, N=1512) and Wave 6 (2012, N=1972). Principal Investigators are Associate Professor [Tan Ern Ser](http://profile.nus.edu.sg/fass/soctanes/){target="_blank"} at NUS (2002), and Associate Professor [Vincent CH Chua](https://www.suss.edu.sg/about-suss/faculty-and-staff/detail/vincent-chua){target="_blank"} at SUSS (2012).

Data can be accessed at <http://www.worldvaluessurvey.org>{target="_blank"}.
