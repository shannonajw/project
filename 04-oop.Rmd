...
Note the qualifier "among those who were aware" is neither in the headline (Figure \@ref(st-watain)) nor the body of the article^[CNA ran a similar headline, but included the qualifier within the article. See https://www.channelnewsasia.com/news/singapore/2-in-3-singaporeans-in-reach-poll-supported-government-s-11401066]. 
