...
where $\Pr(\text{Use Internet Daily } | \text{ Don't Use Internet})$ is impossible and should be zero. In both cases, total probabilites are substantially different from the conditional probabilities.
