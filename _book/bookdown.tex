...
Once again, we can look at age-specific rates to determine if the
explanation is plausible (Figure \ref{fig:apc-reportsingstat2nd}).
...
cohorts (albeit on marriage cohorts, not birth cohorts) are in fact
getting divorced earlier. This directly contradicts the cohort-based
explanation.
