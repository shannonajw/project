...
Minister for Home Affairs K Shanmugam, 1 April 2019, \emph{emphasis
mine}
\end{quote}
...
States\footnote{For instance, see
...
The crucial part of Figure \ref{fig:cb-single} is the footnote that says
``base'', which tells us that the 82\% figure for daily Internet usage
in 2017 are \textbf{among those who use the internet}. We can easily
calculate this 82\% ourselves by using the numbers in Figure
...
is logically impossible, and should equal zero.
