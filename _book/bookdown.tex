...
{\centering \includegraphics[width=0.7\linewidth]{images/yousayisay/news1} 
...
(MOM)\footnote{Instead of the absolute numbers, however, MOM gave me the
  total local retrenchment, and the proportion of PMETs among those. To
  get absolute numbers for local PMET retrenchments, I multiplied the
  total retrenchment by the proportion of PMETs. There may be some small
...
decreasing\footnote{You can also find that as the Factually article
  states, that the proportion of local PMET retrenchments among all PMET
...
One example would be investing in the stock market. Many investors (or
financial advisors) use this adage: ``It's all about time in the market,
not timing the market''. Essentially, what this suggests is that in the
short term, the value of products such as exchange traded funds (ETFs)
will fluctuate up or down, but in the long term (5-10+ years) it will
generally appreciate. Go
...
the increase in retrenchments before a recession, or the decrease in
retrenchments after a recession?} I believe it would raise a red flag if
someone decided to use data from 2007-2009 to show that retrenchments
have increased, or to use data from 2009-2010 to show a decline. I
requote from the judgement here:
