...
focus here. However, information on data that can be linked to
disaggregated datasets (e.g., data on neighbourhood characteristics) to
improve analyses are welcomed.
...
\href{http://profile.nus.edu.sg/fass/soctanes/}{Tan Ern Ser} at NUS
...
\ref{fig:cb-seniorsinternet} - note that 43\footnote{The percent of
  Singapore residents aged 55+ using the internet in 2017, from
  ...
  \emph{daily} in 2017, from \ref{fig:cb-seniorsinternet}}. That is,
\(\frac{43}{53} \approx 0.82\). This recovers the 82\% figure that we
see in Figure \ref{fig:cb-single}.
