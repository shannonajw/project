...
\setlength{\droptitle}{-2em}
  ...
  \postdate{\par}
    \date{Last updated 06 July 2019}
...
Additional reading: Straits Times Reporter Christopher Tan alleges (July
5, 2009) that the Land Transport Authority also makes this kind of
misleading representation of support for legalizing onboard audio
recordings in taxis and private hire cars: See
