...
help me maintain it) may use the in-built annotation feature, or email
me at
...
I will list any Singapore-related dataset that I know of, but my
knowledge is far from exhaustive. To help me out, you can simply alert
me to an unlisted dataset and let me know where to find information on
it (and I will write it up). However, if you could do the following and
send it to me, it would make my task much easier:

Write a short paragraph on the dataset which includes (but is not
limited to) the following information: * Basic details about the dataset
(name, how was data collected, how many observations etc.) * Name(s) of
the Principal Investigator(s) (and links to their webpage/profiles, if
possible) * How to access the dataset (e.g., a website that allows a
direct download or lists instructions to obtain the data)
...
procedure (e.g., signing up for on online account, sending a form with a
research topic). \emph{Restricted} or \emph{Non-publicly available}
datasets are those that require more extensive clearance (e.g., a
background check, use of a data enclave) to access. Data for which there
is no information on access also fall under this criteria. Email me at
\href{mailto:shannon.ang@ntu.edu.sg}{\nolinkurl{shannon.ang@ntu.edu.sg}}
to list a dataset.
...
write grant applications, where to find data). Email me at
\href{mailto:shannon.ang@ntu.edu.sg}{\nolinkurl{shannon.ang@ntu.edu.sg}}
to contribute a think piece.
