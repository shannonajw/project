...
\item
  ...
  (Chapter \ref{race} to Chapter \ref{lifecourse}). These may be short
...
\item
  ...
  improve quantitative social science in Singapore (\ref{think}).
\end{enumerate}
...
\addcontentsline{toc}{section}{Why I set this up}

\chapter{Datasets}\label{data}

\section{Public Datasets}\label{public-datasets}

\section{Restricted Datasets}\label{restricted-datasets}
...
\chapter{Think Pieces}\label{think}
