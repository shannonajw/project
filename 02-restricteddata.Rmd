...
Readers who believe I have wrongly listed a dataset here (i.e., they are not restricted), or have more accurate information than provided, can [contact me](shannon.ang@ntu.edu.sg). Use the in-built annotation feature, or send me an email at <shannon.ang@ntu.edu.sg> if you know about a dataset that should be featured in this list but is not included here.
...
The Singapore Life Panel is housed at the [Centre for Research on the Economics of Ageing](https://crea.smu.edu.sg/singapore-monthly-panel) at SMU. The SLP website does not list any plans to make the dataset publicly available outside of their own research team. The SLP team can be reached at <crea@smu.edu.sg>.
